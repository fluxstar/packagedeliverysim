...
bool AuctionDrone::isAvailable() { return this->sub->isAvailable(); }
...
IStrategy* AuctionDrone::getToPackage() { return this->sub->getToPackage(); }
bool AuctionDrone::hasPickedUp() { return this->sub->hasPickedUp(); }
...
Package* AuctionDrone::getPackage() { return this->sub->getPackage(); }
